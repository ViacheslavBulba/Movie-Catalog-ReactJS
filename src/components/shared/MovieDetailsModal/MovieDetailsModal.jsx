...
export default function MovieDetailsModal(props) {
  ...
  const validate = (values) => {
    ...
    if (!values.posterUrl) {
      ...
      errors.posterUrl = 'Not a valid http link, please enter a valid http link';
    }
    if (!values.overview) {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      title: isEditing ? movie.title : '',
      releaseDate: isEditing ? movie.release_date : '',
      posterUrl: isEditing ? movie.poster_path : '',
      genres: isEditing ? movie.genres : [],
      overview: isEditing ? movie.overview : '',
      runtime: isEditing ? movie.runtime : '',
    },
    validate,
    onSubmit: (values) => {
      if (isEditing) {
        ...
        <Modal.Body>
          <div className="dialog-field-container">
            ...
            <input
              ...
              className={`dialog-field-input ${addRedBorderIfError('title')}`}
          ...
          <div className="dialog-field-container">
            ...
            <input
              ...
              className={`dialog-field-input ${addRedBorderIfError('posterUrl')}`}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
            ...
            {formik.touched.posterUrl && formik.errors.posterUrl ? (
              <span className="error">{formik.errors.posterUrl}</span>
            ) : null}
          </div>
          <div className="dialog-field-container">
          ...
          <div className="dialog-field-container">
            ...
            <input
              ...
              className={`dialog-field-input ${addRedBorderIfError('overview')}`}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
          ...
          <div className="dialog-field-container">
            ...
            <input
              ...
              className={`dialog-field-input ${addRedBorderIfError('runtime')}`}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
